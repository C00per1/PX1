				...
				<div class="container-fluid" style="margin-top: 2%">
					...
					<div class="col-md-8">
						...
						<form action="?page=clients&id=<?php echo $opened['id']; ?>" method="post" role="form">
							...
							<div id="spouse" style="margin-top: 15px">
								<div class="row">
									<div class="form-group col-md-6">
										
										<label for="spousefirst">Spouse First</label>
										<input class="form-control" type="text" name="spousefirst" id="spousefirst" value="<?php echo $opened['spouse_first']; ?>" placeholder="Spouse First Name" autocomplete="off" />
										
									</div>
									
									<div class="form-group col-md-6">
										
										<label for="spouselast">Spouse Last</label>
										<input class="form-control" type="text" name="spouselast" id="spouselast" value="<?php echo $opened['spouse_last']; ?>" placeholder="Spouse Last Name" autocomplete="off" />
								...
								<div class="row">
									<div class="form-group col-md-4">
										...
										<select class="form-control" name="spousegender" id="spousegender">
											
											<option value="0" <?php if(isset($_GET['id'])) { selected('0', $opened['spouse_gender'], 'selected'); } ?>>Male</option>
											<option value="1" <?php if(isset($_GET['id'])) { selected('1', $opened['spouse_gender'], 'selected'); } ?>>Female</option>
									...
									<div class="form-group col-md-4">
										...
										<input class="form-control" type="date" name="spousedob" id="spousedob" value="<?php echo $opened['spouse_dob']; ?>" autocomplete="off" />
									</div>
								</div>
							</div>
